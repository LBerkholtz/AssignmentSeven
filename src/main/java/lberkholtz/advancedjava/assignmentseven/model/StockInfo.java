package lberkholtz.advancedjava.assignmentseven.model;
 ...
 */
public class StockInfo extends StockData {
     ...
     */
    public StockInfo(BigDecimal price, Date date, String symbol) {
        super();
        this.price = price;
        this.date = date;
        this.symbol = symbol;
