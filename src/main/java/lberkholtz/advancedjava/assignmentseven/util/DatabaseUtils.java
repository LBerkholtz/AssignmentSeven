...
import lberkholtz.advancedjava.assignmentseven.model.database.DatabaseAccessObject;
...
/**
 * A class that contains model related utility methods.
 */
public class DatabaseUtils {
    ...
    public static Connection getConnection() throws DatabaseConnectionException {
        ...
        try {
            ...
            throw new DatabaseConnectionException("Could not connection to model." + message, e);
        }
        return connection;
    }
    ...
    /*
   * @return SessionFactory for use with model transactions
   */
    ...
    /**
     * Create a new or return an existing model configuration object.
     *
